...
Some thoughts on your client's weekly mileage target: {mileage_recommendation}
...
def generate_week(
    ...
    :param user_preferences: Client's preferences
    :param mileage_recommendation: Coach's target for the week
...
def generate_new_training_week(
    user_preferences: Preferences, mileage_recommendation: MileageRecommendation
) -> TrainingWeek:
